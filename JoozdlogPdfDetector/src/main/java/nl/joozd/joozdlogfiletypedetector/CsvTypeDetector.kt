...
class CsvTypeDetector(inputStream: InputStream): FileTypeDetector {
    ...
    private fun getType(lines: List<String>?): SupportedTypes = when (lines?.firstOrNull()){
        ...
        LOGTEN_PRO -> SupportedTypes.LOGTEN_PRO_LOGBOOK
