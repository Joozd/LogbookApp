...
class CsvTypeDetector(inputStream: InputStream): FileTypeDetector {
    ...
    private fun getType(lines: List<String>?): SupportedTypes.SupportedType = when (lines?.firstOrNull()){
        ...
        JOOZDLOG_V4_IDENTIFIER, JOOZDLOG_V5_IDENTIFIER -> SupportedTypes.JOOZDLOG_CSV_BACKUP
    ...
    companion object{
        ...
        private const val JOOZDLOG_V5_IDENTIFIER = "flightID;Origin;dest;timeOut;timeIn;correctedTotalTime;multiPilotTime;nightTime;ifrTime;simTime;aircraftType;registration;name;name2;takeOffDay;takeOffNight;landingDay;landingNight;autoLand;flightNumber;remarks;isPIC;isPICUS;isCoPilot;isDual;isInstructor;isSim;isPF;isPlanned;autoFill;augmentedCrew;signature"
