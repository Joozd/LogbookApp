...
class BalanceForwardAdapterOld (private val context: Context, val initialBalancesForward: List<BalanceForward>, val listView: ExpandableListView) : BaseExpandableListAdapter() {
    ...
    override fun getGroupView(listPosition: Int, isExpanded: Boolean, convertView: View?, parent: ViewGroup): View {
        ...
        val listTitleTextView = TextView(context)
        val actionImageView = TextView(context)
