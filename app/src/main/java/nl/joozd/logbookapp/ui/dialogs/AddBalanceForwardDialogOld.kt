...
@Deprecated ("Make new")
class AddBalanceForwardDialogOld: Fragment() {
    companion object{
    ...
    set(value){
        ...
        thisView?.let{v ->
            ...
            v.multiPilotTimeEditText.setText(value.aircraftTime.minutesToTimeString())
            v.totalTimeOfFlightEditText.setText(value.simTime.minutesToTimeString())
            // v.simulatorTimeEditText.setText(value.takeOffDay.toString())
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        thisView?.let {thisView ->
            ...
            thisView.multiPilotTimeEditText.onFocusChangeListener =
            ...
            thisView.totalTimeOfFlightEditText.onFocusChangeListener =
                View.OnFocusChangeListener { vw, hasFocus ->
                    val v = vw as TextInputEditText
                    if (hasFocus) {
                        v.selectAll()
            ...
            thisView.simulatorTimeEditText.onFocusChangeListener =
                View.OnFocusChangeListener { vw, hasFocus ->
                    val v = vw as TextInputEditText
                    if (hasFocus) {
                        v.selectAll()
 ...
 */
            ...
            thisView.cancelBalanceForwardDialogButton.setOnClickListener { fragmentManager?.popBackStack() }

            thisView.saveBalanceForwardDialogButton.setOnClickListener {
