...
@Deprecated ("Switch to [JoozdlogAlertDialog]")
class JoozdlogAlertDialogV1(val ctx: FragmentActivity): DialogFragment() {
    ...
    inline fun show(tag: String = "bla", block: JoozdlogAlertDialogV1.() -> Unit = {}): JoozdlogAlertDialogV1 {
        block()
